...
const BreandMain = () => {
    ...
    return (
        <div className='ratio ratio-16x9 '>
            <div className = "d-md-flex justify-content-center align-items-center " style={imageStyle}>
            <div className='text-center '>
                ...
                <Link className="nav-link" to="brend">
                    <button className='btn btn-success m-md-3'><h6>УЗНАЙТЕ ПОДРОБНЕЕ О BIOAQUA</h6></button>
                </Link>
